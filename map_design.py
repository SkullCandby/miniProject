...
class Ui_MapsApp(object):
    def setupUi(self, MapsApp):
        ...
        self.pushButton.setGeometry(QtCore.QRect(890, 20, 71, 23))
        self.pushButton.setObjectName("pushButton")
        self.view_box = QtWidgets.QComboBox(self.centralwidget)
        self.view_box.setGeometry(QtCore.QRect(1040, 20, 71, 22))
        self.view_box.setObjectName("view_box")
        self.view_box.addItem("")
        self.view_box.addItem("")
        self.view_box.addItem("")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(980, 20, 81, 21))
        self.label_5.setObjectName("label_5")
        self.enable_button = QtWidgets.QPushButton(self.centralwidget)
        self.enable_button.setGeometry(QtCore.QRect(970, 50, 141, 21))
    ...
    def retranslateUi(self, MapsApp):
        ...
        self.pushButton.setText(_translate("MapsApp", "search"))
        self.view_box.setItemText(0, _translate("MapsApp", "map"))
        self.view_box.setItemText(1, _translate("MapsApp", "satellite"))
        self.view_box.setItemText(2, _translate("MapsApp", "hybrid"))
        self.label_5.setText(_translate("MapsApp", "view"))
        self.enable_button.setText(_translate("MapsApp", "change coords"))
